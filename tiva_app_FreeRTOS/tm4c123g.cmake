...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mthumb ${CPU} ${FPU} -std=gnu99 -Os -ffunction-sections -fdata-sections -fsingle-precision-constant -MD -Wall -pedantic")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mthumb ${CPU} ${FPU}  -Os -ffunction-sections -fdata-sections -fisngle-precision-constant -MD -Wall -pedantic -fno-exceptions -fno-rtti")

set(CMAKE_C_LINK_FLAGS "-Wl,-Map=${CMAKE_PROJECT_NAME}.map")
set(CMAKE_CXX_LINK_FLAGS  "-Wl,-Map=${CMAKE_PROJECT_NAME}.map")
